...
const BeamCircle: React.FC<BeamCircleProps> = ({
  ...
  const CenterIcon = useMemo(
    () => (
      <motion.div
        className="rounded-full shadow-lg bg-[#0a0a0a] border border-white/10 grid place-content-center"
          ...
          return (
            <React.Fragment key={orbit.id}>
              ...
              >
                ...
                >
                  <motion.div
                    className="rounded-full shadow-md grid place-content-center bg-[#0a0a0a] border border-white/10 p-1"
...
export { BeamCircle };
export type { OrbitConfig, BeamCircleProps };
